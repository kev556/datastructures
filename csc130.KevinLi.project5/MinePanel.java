...
* <b>Date Written:</b> December 16, 2023<br>
* <b>Due Date:</b> December 19, 2023<br>
* <p>
* <b>Description:</b><br>
* Demonstrate knowledge of recursion by implementing a recursive method
* removeAdjacentButtons that removes all adjacent safe squares with one click on a 
* safe square on MineSweeper.
* </p> <br>
* <p>
*</p>
*@author Kevin Li
...
//		System.out.println("x = " + x + " y = "+y);
	...
	*/
	public void removeAdjacentButtons(Graphics g,int r, int c)
	{
		...
		if (r >= button.length || r < 0 || c >= button[0].length || c < 0 || button[r][c].isMined() || button[r][c].isShowing())
			return;
